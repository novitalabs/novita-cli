...
- Removed deprecated setuptools license classifier usage.
...
### Changed
- PyPI package now includes CHANGELOG in long description
- README updated with complete command reference table (37 commands)
